...
from app.services.segmenter_service import ToolService
...
@shared_task(bind=True, max_retries=1, default_retry_delay=10, name="segmenter.run")
def run_segmenter(self, progress_id: str, input_payload: dict):
    try:
        ...
        log.exception("Segmenter task failed")

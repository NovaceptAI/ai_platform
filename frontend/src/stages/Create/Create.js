...
const createTools = [
  ...
  { name: 'Interactive Comic Strip Builder', path: '/comic_strip_builder', icon: <FaProjectDiagram />, colorClass: 'card-green' },
  { name: 'AI Presentation Builder', path: '/ai_presentation_builder', icon: <FaChalkboardTeacher />, colorClass: 'card-amber' },
  { name: 'AI Art Creator for Kids', path: '/ai_art_creator_kids', icon: <FaPaintBrush />, colorClass: 'card-blue' },
  { name: '3D Model Builder', path: '/model_builder_3d', icon: <FaCube />, colorClass: 'card-teal' },

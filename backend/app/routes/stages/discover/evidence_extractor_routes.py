...
def start_evidence_extraction():
    ...
    log.info(f"[EvidenceExtractor] Start request - file_id: {file_id}, user_id: {user_id}, force: {force}")

    if not file_id or not user_id:
        log.error(f"[EvidenceExtractor] Missing required params - file_id: {file_id}, user_id: {user_id}")
